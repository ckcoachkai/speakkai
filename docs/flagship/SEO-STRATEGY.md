# SEO strategy — working reference through V19

Reconcile route and media additions at V30. Search rankings, impressions and organic conversions are not measured by the current checks.
...
English/Chinese course and practice pairs use reciprocal language links and hreflang, with English as x-default. A language alternative must offer corresponding content. Keep draft practices out of generated routes, sitemap and public data.
