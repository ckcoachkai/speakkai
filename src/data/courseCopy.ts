...
export const courseCopy = {
  en: {
    ...
    exampleLabel: "Fictional practice example · not a student testimonial",
    firstTry: "First try", coachFeedback: "Coach feedback", pauseRetry: "Retry with one pause",
    pauseCue: "Pause", pauseHelp: "“Pause” is a rehearsal cue, not a word to say.",
    listenerCheck: "Ask the listener: why did this matter to the speaker? Notice whether the pause changes what you hear. There is no single required pause length.",
  ...
  "zh-CN": {
    ...
    exampleLabel: "虚构练习示例 · 并非学生评价",
    firstTry: "第一次尝试", coachFeedback: "老师的反馈", pauseRetry: "加一处停顿，再试一次",
    pauseCue: "停顿", pauseHelp: "“停顿”是练习提示，不需要把这两个字读出来。",
