...
export const serviceCopy: Record<SiteLanguage, ServiceCopy> = {
  en: {
    ...
    audiences: [
      { id: 'early', title: 'Early years · around age 5–Grade 1', description: 'Guided or prepared speeches, familiar topics and personal stories. Practise facial expressions, eye contact and gestures. Stronger speakers can explore simplified SDG and environmental topics through their own experiences.' },
      ...
      { id: 'adult', title: 'Adults & organisations', description: 'Work on professional interviews, everyday communication, team training, leadership presentations, business storytelling or an important pitch.' },
    ],
    ...
    arrangements: 'Personalised one-to-one coaching and private groups, subject to availability. Looking to join an existing group? Kai can connect you with partner programmes. Sessions are primarily in person. Share the learner’s age, goals, preferred format and any deadline to discuss a suitable next step.',
    online: 'Online classes coming soon.', schools: 'Explore school programmes and workshops',
