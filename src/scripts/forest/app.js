...
function frame(now){
 ...
 const encounterAge=encounter?time-encounter.start:-1,hit=punchAt(encounterAge);const dancing=hostId==='elton'&&encounter&&!encounter.shown&&encounterAge>=ENCOUNTER_DURATION;const dance=dancing?dancePose(encounterAge-ENCOUNTER_DURATION,gentle):null;
 ...
 if(encounter&&!encounter.shown&&time-encounter.start>=ENCOUNTER_DURATION+(hostId==='elton'?DANCE_DURATION:0))revealResult();
