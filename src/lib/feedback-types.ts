export type FeedbackStudent = {id:string;name:string;en:string|null;zh:string|null};
export type FeedbackSession = {id:string;date:string;time:string;status:'held'|'cancelled';students:FeedbackStudent[]};
